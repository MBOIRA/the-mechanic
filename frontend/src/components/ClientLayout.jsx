...
const ClientLayout = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="flex">
        {/* Sidebar - Desktop */}
        <aside className="hidden md:flex md:flex-col md:w-72 md:fixed md:inset-y-0 bg-white/90 backdrop-blur-xl border-r border-gray-200 shadow-sm">
          <div className="flex flex-col h-full">
            {/* Logo */}
            <div className="flex items-center px-6 py-6 border-b border-gray-100">
              <Link to="/client/dashboard" className="flex items-center space-x-3 group">
                <div className="bg-primary-500 p-2 rounded-lg group-hover:bg-primary-600 transition-colors shadow-sm">
                  <Wrench className="h-6 w-6 text-white" />
                </div>
                <span className="text-2xl font-black text-gray-900 tracking-tight uppercase">Mechanics<span className="text-primary-500">Hub</span></span>
              </Link>
            </div>
            ...
            <div className="p-4 border-t border-gray-100">
              <div className="flex items-center space-x-3 mb-4 p-3 bg-gray-100 rounded-xl">
              ...
              <button
                ...
                className="flex items-center justify-center space-x-2 w-full px-4 py-3 rounded-xl text-sm font-bold text-gray-700 hover:bg-red-50 hover:text-red-700 transition-all duration-200"
              >
        ...
        {isSidebarOpen && (
          <div className="md:hidden fixed inset-0 z-50">
            <div className="fixed inset-0 bg-gray-900/50 backdrop-blur-sm" onClick={() => setIsSidebarOpen(false)} />
            <aside className="fixed inset-y-0 left-0 w-72 bg-white/95 backdrop-blur-xl shadow-2xl">
              <div className="flex flex-col h-full">
                <div className="flex items-center justify-between px-4 py-4 border-b border-gray-100">
                  <span className="font-black text-gray-900 tracking-tight uppercase">Menu</span>
                  <button
        ...
        <main className="flex-1 md:ml-72">
          ...
          <header className="hidden md:flex items-center justify-between px-8 py-4 bg-white/80 backdrop-blur-lg border-b border-gray-200 shadow-sm">
            ...
            <div className="flex items-center space-x-4">
              <Link to="/client/notifications" className="p-2.5 rounded-xl text-gray-600 hover:bg-primary-50 hover:text-primary-700 transition-all duration-200 relative">
                <Bell className="h-5 w-5" />
              </Link>
              <div className="flex items-center space-x-3 p-2 bg-gray-100 rounded-xl">
